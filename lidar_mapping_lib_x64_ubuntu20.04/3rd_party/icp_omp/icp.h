...
private:
	...
	virtual double               fitStep_new(double *T,const int32_t T_num,Matrix &R,Matrix &t,const std::vector<std::pair<int32_t,int32_t>> &active) = 0;
	virtual std::vector< std::pair<int32_t, int32_t> > getInliers(double *T,const int32_t T_num,const Matrix &R,const Matrix &t,const double indist) = 0;
	
	virtual double getResidual(double *T,const int32_t T_num,const Matrix &R,const Matrix &t,const std::vector<std::pair<int,int>> &active)=0;
...
protected:
	...
	std::vector<std::pair<int,int>>	m_active; //inliers 
